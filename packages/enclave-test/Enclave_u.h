...
UserSpaceBuffer SGX_UBRIDGE(SGX_NOCONVENTION, ocall_allocate, (const uint8_t* buffer, uintptr_t length));
#endif
#ifndef OCALL_READ_DB_DEFINED__
#define OCALL_READ_DB_DEFINED__
OcallReturn SGX_UBRIDGE(SGX_NOCONVENTION, ocall_read_db, (Ctx context, UntrustedVmError* vm_error, uint64_t* gas_used, EnclaveBuffer* value, const uint8_t* key, uintptr_t key_len));
#endif
#ifndef OCALL_REMOVE_DB_DEFINED__
#define OCALL_REMOVE_DB_DEFINED__
OcallReturn SGX_UBRIDGE(SGX_NOCONVENTION, ocall_remove_db, (Ctx context, UntrustedVmError* vm_error, uint64_t* gas_used, const uint8_t* key, uintptr_t key_len));
#endif
#ifndef OCALL_WRITE_DB_DEFINED__
#define OCALL_WRITE_DB_DEFINED__
OcallReturn SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write_db, (Ctx context, UntrustedVmError* vm_error, uint64_t* gas_used, const uint8_t* key, uintptr_t key_len, const uint8_t* value, uintptr_t value_len));
#endif
